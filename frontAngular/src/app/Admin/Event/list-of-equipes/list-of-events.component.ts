...
export class ListOfEventsComponent implements OnInit {
  ...
  reloadComponentWithRandomParam() {
    const randomParam = Math.random(); // Génère un paramètre aléatoire pour forcer le rafraîchissement
    this._routerUp.navigate(['/Event'], { queryParams: { random: randomParam } });
  }
